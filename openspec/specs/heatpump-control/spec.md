...
Retrieves the current heatpump state and translates control commands from the REST API into HTTP requests to the heatpump web UI, acting as a faithful proxy without adding its own command semantics.
