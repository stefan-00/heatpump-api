...
- [x] 7.4 Apply the HC1 and HC2 number entity config and reload → confirm all 12 setpoint number entities show correct current values
- [x] 7.5 Change one number entity value in HA UI → confirm API returns 200, device reflects the change, entity updates; restore original value
